...
$sql[] = "CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "idnk_carousel` (
          ...
          `nb_product_to_scroll`      int(10) unsigned NOT NULL DEFAULT '2',
...
// Install table lang
$sql[] = "CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "idnk_carousel_lang` (
...
$sql[] = "CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "idnk_carousel_category_association` (
        `id_carousel`   int(10) unsigned NOT NULL,
